        ...
        <Card>
            ...
            <CardContent>
                <ImageList cols={3} gap={8} sx={{ maxHeight: 600 }}>
                    <ImageListItem key="1">
                        <img src={img_1} alt="フェアリング班の作業風景1" />
                    </ImageListItem>
                    <ImageListItem key="2">
                        <img src={img_2} alt="フェアリング班の作業風景2" />
                    </ImageListItem>
                </ImageList>

                <Typography>
                    みなさん、こんにちは！科学大meisterフェアリング班です。フェアリングとは、人力飛行機のコクピットの外殻の部品です。パイロットを真夏の琵琶湖の日差しや強風から守り、快適なフライトを実現させるとともに、落下した際にパイロットを危険から守るという非常に重要な役割を担っています。<br />
                    私たちmeisterのフェアリングは、発泡スチロールでの一体成型という形式をとっています。この形式をとっているのは人力飛行機をつくるサークル界隈でも非常に数が少なく、科学大meisterの技術力のなせる業と言っても過言でありません！　<br />
